...
interface AttachmentModalProps {
  visible: boolean;
  onClose: () => void;
  onSelect: (attachments: EmailAttachment[]) => void;
  entityType?: "deal" | "lead"; // Optional prop to distinguish between deal and lead
  entityUUID?: string; // Optional UUID for the specific entity
}
...
const mockProducts: mockProduct[] = [
    ...
    categories: [
        ...
        documents: [
          {
            ...
            path: "/products/crm/guides/getting-started.pdf",
            size: "2.5 MB",
            type: "pdf",
          ...
          {
            id: 2,
            name: "Advanced_Features_Manual.pdf",
            path: "/products/crm/guides/advanced-features.pdf",
            size: "3.2 MB",
            type: "pdf",
          ...
          {
            id: 3,
            name: "Admin_Setup.pdf",
            path: "/products/crm/guides/admin-setup.pdf",
            size: "1.8 MB",
            type: "pdf",
          ...
          {
            id: 4,
            name: "Integration_Handbook.pdf",
            path: "/products/crm/guides/integration.pdf",
            size: "2.1 MB",
            type: "pdf",
      ...
      },
      {
        ...
        documents: [
          {
            id: 5,
            name: "Retail_Success_Story.pdf",
            path: "/products/crm/cases/retail.pdf",
            size: "4.2 MB",
            type: "pdf",
          ...
          {
            id: 6,
            name: "Healthcare_Implementation.pdf",
            path: "/products/crm/cases/healthcare.pdf",
            size: "3.8 MB",
            type: "pdf",
          ...
          {
            id: 7,
            name: "Financial_Services_Case.pdf",
            path: "/products/crm/cases/financial.pdf",
            size: "2.9 MB",
            type: "pdf",
        ...
        documents: [
          {
            ...
            path: "/products/crm/tech/api.pdf",
            size: "5.1 MB",
            type: "pdf",
          ...
          },
          {
            ...
            path: "/products/crm/tech/database.pdf",
            size: "1.5 MB",
            type: "pdf",
          ...
          },
          {
            ...
            path: "/products/crm/tech/security.pdf",
            size: "2.3 MB",
            type: "pdf",
            modified: new Date("2024-01-15"),
          },
        ...
        documents: [
          {
            ...
            path: "/products/crm/marketing/brochure.pdf",
            size: "3.7 MB",
            type: "pdf",
          ...
          },
          {
            ...
            path: "/products/crm/marketing/sales-presentation.pptx",
            size: "8.5 MB",
            type: "pptx",
          ...
          },
          {
            ...
            path: "/products/crm/marketing/email-templates.zip",
            size: "1.2 MB",
            type: "zip",
  ...
  },
  {
    ...
    description:
      "Analytics Platform is a data analytics and business intelligence solution.",
    categories: [
      {
        id: "product2/cat1",
        name: "User Guides",
        documents: [
          {
            id: 14,
            name: "Quick_Start_Guide.pdf",
            path: "/products/analytics/guides/quick-start.pdf",
            size: "1.9 MB",
            type: "pdf",
          ...
          {
            id: 15,
            name: "Dashboard_Creation.pdf",
            path: "/products/analytics/guides/dashboard.pdf",
            size: "2.7 MB",
            type: "pdf",
          ...
          {
            id: 16,
            name: "Data_Connection_Manual.pdf",
            path: "/products/analytics/guides/data-connection.pdf",
            size: "3.1 MB",
            type: "pdf",
            modified: new Date("2024-01-09"),
          },
          {
            id: 17,
            name: "Report_Building.pdf",
            path: "/products/analytics/guides/report-building.pdf",
            size: "2.4 MB",
            type: "pdf",
      ...
      },
      {
        ...
        documents: [
          {
            id: 18,
            name: "E-commerce_Analytics.pdf",
            path: "/products/analytics/cases/ecommerce.pdf",
            size: "4.5 MB",
            type: "pdf",
          ...
          {
            id: 19,
            name: "Manufacturing_Insights.pdf",
            path: "/products/analytics/cases/manufacturing.pdf",
            size: "3.9 MB",
            type: "pdf",
            modified: new Date("2024-01-10"),
          },
          {
            id: 20,
            name: "Supply_Chain_Analytics.pdf",
            path: "/products/analytics/cases/supply-chain.pdf",
            size: "4.1 MB",
            type: "pdf",
            modified: new Date("2024-01-08"),
          },
        ...
        documents: [
          {
            id: 21,
            name: "Data_Model.pdf",
            path: "/products/analytics/tech/data-model.pdf",
            size: "2.8 MB",
            type: "pdf",
            modified: new Date("2024-01-19"),
            starred: true,
          ...
          {
            id: 22,
            name: "ETL_Processes.pdf",
            path: "/products/analytics/tech/etl.pdf",
            size: "3.3 MB",
            type: "pdf",
          ...
          },
          {
            ...
            path: "/products/analytics/tech/performance.pdf",
            size: "1.7 MB",
            type: "pdf",
            modified: new Date("2024-01-14"),
          },
      ...
      },
      {
        ...
        documents: [
          {
            id: 24,
            name: "Analytics_Brochure.pdf",
            path: "/products/analytics/marketing/brochure.pdf",
            size: "4.2 MB",
            type: "pdf",
          ...
          {
            id: 25,
            name: "ROI_Calculator.xlsx",
            path: "/products/analytics/marketing/roi-calculator.xlsx",
            size: "1.1 MB",
            type: "xlsx",
            modified: new Date("2024-01-18"),
          },
          {
            id: 26,
            name: "Demo_Videos.zip",
            path: "/products/analytics/marketing/demo-videos.zip",
            size: "15.3 MB",
            type: "zip",
            modified: new Date("2024-01-15"),
          },
  ...
  },
  {
    ...
    description:
      "Project Management Suite is a comprehensive project management solution.",
    categories: [
      {
        id: "product3/cat1",
        name: "User Guides",
        documents: [
          {
            id: 27,
            name: "PM_Suite_Overview.pdf",
            path: "/products/pm/guides/overview.pdf",
            size: "2.2 MB",
            type: "pdf",
            modified: new Date("2024-01-16"),
          },
          {
            id: 28,
            name: "Team_Collaboration.pdf",
            path: "/products/pm/guides/collaboration.pdf",
            size: "1.8 MB",
            type: "pdf",
            modified: new Date("2024-01-13"),
          },
          {
            id: 29,
            name: "Resource_Management.pdf",
            path: "/products/pm/guides/resources.pdf",
            size: "2.5 MB",
            type: "pdf",
            modified: new Date("2024-01-11"),
          },
          {
            id: 30,
            name: "Time_Tracking.pdf",
            path: "/products/pm/guides/time-tracking.pdf",
            size: "1.6 MB",
            type: "pdf",
            modified: new Date("2024-01-09"),
          },
      ...
      },
      {
        ...
        documents: [
          {
            id: 31,
            name: "Software_Development.pdf",
            path: "/products/pm/cases/software-dev.pdf",
            size: "3.7 MB",
            type: "pdf",
            modified: new Date("2024-01-15"),
          },
          {
            id: 32,
            name: "Construction_Project.pdf",
            path: "/products/pm/cases/construction.pdf",
            size: "4.3 MB",
            type: "pdf",
            modified: new Date("2024-01-12"),
          },
          {
            id: 33,
            name: "Marketing_Campaign.pdf",
            path: "/products/pm/cases/marketing.pdf",
            size: "3.1 MB",
            type: "pdf",
            modified: new Date("2024-01-10"),
          },
      ...
      },
      {
        ...
        documents: [
          ...
          {
            id: 35,
            name: "Workflow_Engine.pdf",
            path: "/products/pm/tech/workflow.pdf",
            size: "2.9 MB",
            type: "pdf",
            modified: new Date("2024-01-17"),
          },
          {
            id: 36,
            name: "Notification_System.pdf",
            path: "/products/pm/tech/notifications.pdf",
            size: "1.9 MB",
            type: "pdf",
            modified: new Date("2024-01-14"),
          },
      ...
      },
      {
        ...
        documents: [
          {
            id: 37,
            name: "PM_Suite_Brochure.pdf",
            path: "/products/pm/marketing/brochure.pdf",
            size: "3.5 MB",
            type: "pdf",
            modified: new Date("2024-01-22"),
          },
          {
            id: 38,
            name: "Feature_Comparison.pdf",
            path: "/products/pm/marketing/comparison.pdf",
            size: "2.1 MB",
            type: "pdf",
            modified: new Date("2024-01-19"),
          },
          {
            ...
            path: "/products/pm/marketing/testimonials.pdf",
            size: "3.8 MB",
            type: "pdf",
            modified: new Date("2024-01-17"),
          },
          {
            id: 40,
            name: "Pricing_Sheets.zip",
            path: "/products/pm/marketing/pricing.zip",
            size: "1.3 MB",
            type: "zip",
            modified: new Date("2024-01-15"),
          },
...
const getFileIcon = (type: string): JSX.Element => {
  return (
    FILE_ICON_MAP[type?.toLowerCase()] || (
      <FileUnknownOutlined className="!text-gray-500 text-2xl" />
    )
  );
};
    ...
    if (viewMode === "grid") {
      return (
        ...
        >
          ...
          <Text className="text-center text-sm truncate w-full" ellipsis>
            {doc.name}
          </Text>
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <Text type="secondary" className="text-xs">
            {doc.size} • {GlobalDate(doc.modified.toISOString())}
          </Text>
        </div>
        {showStar && (
          <button
        ...
        {isSelected && <CheckCircleOutlined className="ml-2 text-blue-500" />}
      </div>
    );
  }
);
...
const AttachmentModal = ({
  ...
  const selectedProduct = useMemo(() => {
    ...
    return mockProducts.find(
      (product) => product.productUUID === selectedProductId
    );
  }, [selectedProductId]);

  const selectedCategory = useMemo(() => {
    if (!selectedProduct || !selectedCategoryId) return null;
    return selectedProduct.categories.find(
  ...
  const handleConfirm = useCallback(() => {
    const serverAttachments: EmailAttachment[] = selectedDocs.map((doc) => ({
      filename: doc.name,
      url: doc.path,
      filePath: doc.path,
    ...
    const uploadedAttachments: EmailAttachment[] = uploadedFiles
  ...
  const removeSelectedDoc = useCallback(
    (docId: number) => {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      {mockProducts.map((product) => (
        ...
        >
          ...
          <Title level={5} className="text-center m-2">
            {product.productName}
          </Title>
